export const diveDepthStops = [
  { id: "surface", label: "Surface", depth: "0m", progress: 0 },
  { id: "origins", label: "Shallow", depth: "10m", progress: 0.22 },
  { id: "route", label: "Open water", depth: "50m", progress: 0.48 },
  { id: "principles", label: "Deep", depth: "120m", progress: 0.72 },
  { id: "connections", label: "Abyss", depth: "300m", progress: 1 },
] as const;

export const diveMilestones = [
  {
    stage: "入口",
    title: "ものづくりへの興味",
    description:
